...
union() {
    ...
    union() {
        ...
        sim_traverse(startline_mode="basement");

        sim_angle_R(startline_mode="basement");
        sim_upright_R(startline_mode="basement");
    }
...
union() {
    ...
    sim_hanger_clips(startline_mode="basement");
    sim_hanger_rod(startline_mode="basement");
}
